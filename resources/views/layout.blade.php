  ...
  <body>
    <header>
      <div class="container-fluid shadow-sm p-4 mb-3">
        ...
        <div class="row">
          <div class="col">
            <h2 class="text-center fw-bold">مهرجان التسوق 2022</h2>
          </div>
        </div>
      </div>
    </header>
    ...
    <footer class="pt-1 text-right text-white bg-dark ar-font">
      ...
      <div style="background-color: black;">
        <div class="text-center mb-1">
            <a href="https://wa.me/+967736252017" target="_blank" class="text-white text-decoration-none border-bottom border-white">تطوير وتصميم أحمد بارحيم</a>
        </div>

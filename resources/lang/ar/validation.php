...
return [
    ...
    'custom'               => [
        ...
        'no_of_prizes' => [
            'numeric' => 'يجب أن يكون الحقل رقما',
        ],
        'prize_type_id' => [
            'numeric' => 'اختر نوع جائزة',
            'required' => 'اختر نوع جائزة'
        ],
        'name' => [
            'regex' => 'لابد أن يتكون الاسم من حروف فقط',
            'required' => 'قم بإدخال الاسم',
            'string' => 'لابد أن يكون الاسم نصا'
        ],
        'phone_number' => [
            'numeric' => 'رقم الجوال لابد يكون أرقام إنجليزية فقط',
            'unique' => 'هذا الرقم مسجل من قبل .. تأكد من الرقم أو قم بتسجيل الدخول',
            'required' => 'قم بإدخال الرقم',
            'digits' => 'لابد أن يتكون رقم الجوال من تسعة أرقام'
        ],
        'phone' => [
            'numeric' => 'رقم الجوال لابد يكون أرقام إنجليزية فقط',
            'required' => 'قم بإدخال الرقم',
        ...
        'status' => [
            'unique' => 'لا يمكنك إضافة أكثر من حظ أوفر بنفس الوقت',
        ],
        'store_id' => [
            'numeric' => 'اختر اسم المحل',
            'required' => 'اختر اسم المحل'
        ],
        'bill_no' => [
            'numeric' => 'رقم الفاتورة لابد أن يكون رقماً',
            'required' => 'رقم الفاتورة مطلوب إدخالها'
        ],
        'bill_price' => [
            'numeric' => 'قيمة الفاتورة لابد أن يكون رقماً',
            'required' => 'قيمة الفاتورة مطلوب إدخالها',
            'gte' => 'لابد أن تكون قيمة الفاتورة تساوي عشرة ألف أو أكثر'
        ],
        'bill_img' => [
            'image' => 'الفاتورة لابد أن تكون صورة',
            'required' => 'صورة الفاتورة مطلوبة إدخالها',
            'uploaded' => 'فشل في تحميل صورة الفاتورة'
        ],
        'coupon_no' => [
            'numeric' => 'رقم الكوبون لابد أن يكون رقماً',
            'required' => 'رقم الكوبون مطلوب إدخالها',
            'unique' => 'تم إدخال رقم الكوبون مسبقاً'
        ],
    ],
];
